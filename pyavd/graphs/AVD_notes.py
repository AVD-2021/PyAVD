...
fuel_mass = 1351
empty_mass = 3021
aspect_ratio = 7.5 #! note that the addition of winglets will change the effective aspect ratio
CL = 0.27 #! note that this should probably change at when the exact aerofoil is chosen
wing_loading = 2227
...
wing_area_wing_loading_cruise_start = weight_full_mass / wing_loading

wing_span_full_mass = (wing_area_full_mass*aspect_ratio)**(0.5)
wing_span_cruise_start = (wing_area_cruise_start*aspect_ratio)**(0.5)

wing_span_wing_loading_full_mass = (wing_area_wing_loading_full_mass*aspect_ratio)**(0.5)
wing_span_wing_loading_cruise_start = (wing_area_wing_loading_full_mass*aspect_ratio)**(0.5)


reynolds_full_mass = (height_40["density"]*velocity*0.6)/ height_40["dynamic_viscosity"]
reynolds_cruise_start = (height_40["density"]*velocity*0.6)/ height_40["dynamic_viscosity"]
